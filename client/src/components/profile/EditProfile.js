...
const EditProfile = () => {
    ...
    const { first_name, last_name, gender, email, contact_number, city, address, zip_code, country, about, dob } = formData
    ...
    const saveChanges = async () => {
        const imageName = `profile/${formData.first_name}_${formData.last_name}/${userId}.jpg`
        const params = {
            Bucket: bucketName,
            Key: imageName,
            Expires: 60,
            ...
            <Card style={{ marginLeft: "20%", marginRight: "20%", marginTop: 20 }}>
                ...
                <Card.Body>
                    <Card.Text>
                        <Row style={{ margin: 20 }}>
                            <Col sm={3}>
                                <Image rounded width={175} height={150} src={formData.profile_img ? formData.profile_img : defaultProfileImg} />
                            </Col>
                            <Col sm={3}></Col>
                            <Col>
                        ...
                        <Row style={{ margin: 20 }}>
                            ...
                            <Col>
                                <Form className="d-flex" >
                                    <Form.Group className="mb-3" controlId="formBasicName">
                                        <Form.Control type="number" placeholder="" name="contact_number" value={contact_number} onChange={(e) => updateFormData(e)} />
                                    </Form.Group>
                                </Form>
                            </Col>
                        </Row>
                        ...
                        <Row style={{ margin: 20 }}>
                            ...
                            <Col>
                                ...
                                <Row>
                                    <Form className="d-flex" >
                                        <Form.Group className="mb-3" controlId="formBasicName">
                                            <Form.Control type="text" placeholder="Zip Code" name="zip_code" value={zip_code} onChange={(e) => updateFormData(e)} />
                                        </Form.Group>
                                    </Form>
                                </Row>
                            </Col>
